...
set shortmess=aoO
badd +1 spec/models/booth_spec.rb
badd +0 spec/requests/booths_spec.rb
argglobal
silent! argdel *
edit spec/requests/booths_spec.rb
...
wincmd w
argglobal
edit spec/models/booth_spec.rb
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <S-Tab> <Plug>delimitMateS-Tab
imap <buffer> <S-BS> <Plug>delimitMateS-BS
