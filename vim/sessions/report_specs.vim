...
set shortmess=aoO
badd +503 spec/models/report_spec.rb
badd +9 lib/reporting_helper.rb
argglobal
silent! argdel *
edit spec/models/report_spec.rb
...
silent! normal! zE
let s:l = 157 - ((47 * winheight(0) + 26) / 53)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 599 - ((45 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
599
