...
nnoremap  d :let _s=@/|:%s/\s\+$//e|:let @/=_s|:nohl
...
set shortmess=aoO
badd +1 lib/reporting_helper.rb
badd +467 app/assets/javascripts/reports.js.coffee
argglobal
silent! argdel *
edit lib/reporting_helper.rb
...
wincmd w
argglobal
edit app/assets/javascripts/reports.js.coffee
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <S-Tab> <Plug>delimitMateS-Tab
imap <buffer> <S-BS> <Plug>delimitMateS-BS
...
setlocal lispwords=
setlocal nolist
setlocal makeprg=coffee\ -c\ \ \ $*\ app/assets/javascripts/reports.js.coffee
setlocal matchpairs=(:),{:},[:]
setlocal modeline
setlocal modifiable
setlocal nrformats=octal,hex
...
setlocal path=.,~/projects/handshake/lib,~/projects/handshake/vendor,~/projects/handshake/app/models/concerns,~/projects/handshake/app/controllers/concerns,~/projects/handshake/app/controllers,~/projects/handshake/app/helpers,~/projects/handshake/app/mailers,~/projects/handshake/app/models,~/projects/handshake/app/*,~/projects/handshake/app/views,~/projects/handshake/app/views/reports,~/projects/handshake/public,~/projects/handshake/spec,~/projects/handshake/spec/controllers,~/projects/handshake/spec/helpers,~/projects/handshake/spec/mailers,~/projects/handshake/spec/models,~/projects/handshake/spec/views,~/projects/handshake/spec/lib,~/projects/handshake/spec/features,~/projects/handshake/spec/requests,~/projects/handshake/spec/integration,~/projects/handshake/vendor/plugins/*/lib,~/projects/handshake/vendor/plugins/*/test,~/projects/handshake/vendor/rails/*/lib,~/projects/handshake/vendor/rails/*/test,~/projects/handshake,/usr/include,
setlocal nopreserveindent
setlocal nopreviewwindow
setlocal quoteescape=\\
setlocal noreadonly
...
setlocal tabstop=2
setlocal tags=~/projects/handshake/.git/coffee.tags,~/projects/handshake/.git/tags,~/projects/handshake/tags,~/projects/handshake/tmp/tags,./tags,tags
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal undolevels=-123456
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 467 - ((26 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
467
